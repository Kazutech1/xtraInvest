...
const Testimonials = () => {
  ...
  return (
    <div>
      ...
      <section className="bg-gray-100 py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-14 text-center">
          ...
          <div className="relative max-w-4xl mx-auto">
            {/* Large Quote Mark */}
            <div className="font-['Dancing_Script'] text-6xl md:text-9xl text-gray-300/50 mb-2 -mt-4">
              &ldquo;
            </div>
            ...
            <div className="relative overflow-hidden">
              ...
              >
                ...
                <div className="w-full flex-shrink-0 px-4 md:px-8">
                  ...
                  <div className="flex items-center justify-center gap-4 md:gap-6">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-gray-400">
                      <img src={tst1} alt="William Someone" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="w-full flex-shrink-0 px-4 md:px-8">
                  ...
                  <div className="flex items-center justify-center gap-4 md:gap-6">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-gray-400">
                      <img src={tst2} alt="Jack Murphy" className="w-full h-full object-cover" />
                    </div>
                    <div className="text-left">
                ...
                <div className="w-full flex-shrink-0 px-4 md:px-8">
                  ...
                  <div className="flex items-center justify-center gap-4 md:gap-6">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-gray-400">
                      <img src={tst3} alt="Jennifer Johanson" className="w-full h-full object-cover" />
                    </div>
                    <div className="text-left">
      ...
      {/* Experience Section */}
      <section className="bg-gray-100 py-8 md:py-0">
          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="bg-gray-200 p-8 md:p-16 flex flex-col justify-center">
              <div className="text-center">
                ...
                <div className="text-slate-800 text-lg md:text-xl font-medium tracking-wider uppercase">
                  YEARS OF 
                  <br />
                  EXPERIENCE
                </div>
            ...
            <div className="relative min-h-[400px] md:min-h-[500px]">
              {/* Team Image */}
              <div className="absolute top-0 md:-top-20 left-0 right-0 h-48 md:h-80 overflow-hidden">
                <img 
                  src={img2} 
              ...
              {/* Content Box */}
              <div className="absolute bottom-0 md:-bottom-10 left-0 md:-left-32 right-0 md:right-auto md:w-96 bg-slate-700 p-6 md:p-10 text-gray-300">
